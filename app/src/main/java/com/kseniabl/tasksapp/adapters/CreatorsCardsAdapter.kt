...
class CreatorsCardsAdapter @Inject constructor(private val context: Context): RecyclerView.Adapter<CreatorsCardsAdapter.CreatorCardsHolder>(), AllCardsAdapterInterface {
